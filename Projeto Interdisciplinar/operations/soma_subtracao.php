                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="operacao" id="operacao" class="form-select">
                                <option value="soma" <?php echo $operacao == 'soma' ? 'selected' : ''; ?>>Soma (A + B)</option>
                                <option value="subtracao" <?php echo $operacao == 'subtracao' ? 'selected' : ''; ?>>Subtração (A - B)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="linhas" id="linhas" min="1" max="6" value="<?php echo $linhas; ?>" required class="form-input">
                        </div>
