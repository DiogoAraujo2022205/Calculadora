    ...
    <div class="container">
            ...
            <div class="operations-grid">
                ...
                <a href="" class="operation-card">
                    <div class="operation-content">
                        ...
                        <p>Cálculo da matriz inversa (se existir)</p>
                    </div>
                </a>

                <!-- Operação 6 -->
                <a href="operations/criptografar_descriptografar.php" class="operation-card">
                    <div class="operation-content">
                        <h3>6. Criptografar e descriptografar</h3>
        ...
        <footer class="main-footer">           
            <div class="footer-bottom">
                <p> 2025-2026 - Projeto Interdisciplinar - Calculadora de Matrizes</p>
            </div>
        </footer>
    </div>
</body>
