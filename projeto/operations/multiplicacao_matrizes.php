...
$resultado = '';
$erro = ''; //variavel que vai conter mensagens de erro
$matrizA = [];
$matrizB = [];
$matrizResultado = []; //variavel que vai conter o resultado da multiplicação 
$linhasA = 2; 
$colunasA = 2;
$linhasB = 2;
$colunasB = 2;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['configurar'])) {
        //inicializar as variaveis na dimensao 2x2 
